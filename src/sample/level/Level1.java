...
public class Level1 extends Level {
    ...
    public void createWalls() {
        ...
        walls.add(new Level.Wall(textureWalls.get(3), 120, 472, 30, 30, new Rectangle(120, 472, 30, 30) ));
        walls.add(new Level.Wall(textureWalls.get(3), 360, 472, 30, 30, new Rectangle(360, 472, 30, 30) ));
        walls.add(new Level.Wall(textureWalls.get(3), 360, 232, 30, 30, new Rectangle(360, 232, 30, 30) ));
        walls.add(new Level.Wall(textureWalls.get(3), 840, 232, 30, 30, new Rectangle(840, 232, 30, 30) ));
        walls.add(new Level.Wall(textureWalls.get(3), 840, 472, 30, 30, new Rectangle(840, 472, 30, 30) ));
        walls.add(new Level.Wall(textureWalls.get(3), 600, 472, 30, 30, new Rectangle(600, 472, 30, 30) ));
        walls.add(new Level.Wall(textureWalls.get(3), 600, 712, 30, 30, new Rectangle(600, 712, 30, 30) ));
        walls.add(new Level.Wall(textureWalls.get(3), 120, 712, 30, 30, new Rectangle(120, 712, 30, 30) ));
